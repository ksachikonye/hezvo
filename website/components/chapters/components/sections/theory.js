...
const AnimatedLine = ({ sentence }) => {
    ...
    return (<span className="inline-block md:text-3xl" ref={lineContainerRef}>
      <span className="inline-block md:text-3xl opacity-0 translate-y-10" ref={lineRef}>
        {sentence}
      </span>
    </span>);
};
